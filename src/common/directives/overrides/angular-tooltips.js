/***
 * Override by HuyD
 * vendor\angular-tooltips\src\js
 */
      ...
      'link': function linkingFunction($scope, element, attr) {
        ...
        // Override by HuyD
          ...
          htmlTemplate =
            ...
            '  <div class="' + CSS_PREFIX + 'content"> ' + content + '</div>' +
            '  <span class="' + CSS_PREFIX + 'caret"></span>' +
            '</div>';
        // End Override
        ...
        $scope.setTooltipContent = function(content) {
          theTooltip.find('.' + CSS_PREFIX + 'content').html(content);
          $scope.tooltipTryPosition();
        };

        $scope.setShowing = function(isShowing) {
          showing = isShowing;
        };
