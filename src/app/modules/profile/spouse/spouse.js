angular.module('app.modules.profile.spouse', [])

.controller('ProfileSpouseController', function($scope, $stateParams, $state, $translate, IMAGECONFIGS, ERRORCODES, security, utils, participants, employers, agents, users, healthCoachs, superadmins, healthCoachManagers, clientManagers, clinicalDirectors, admins, QUESTIONS) {
