angular.module('app.modules.question.list-question', [])

.config(function($stateProvider){
    $stateProvider
        .state('loggedIn.modules.list-question', {
            url: '/list-question',
            views: {
                'main-content': {
                    templateUrl: 'modules/question/list-question/list-question.tpl.html',
                    controller: 'QuestionListQuestionController'
                }
            }
        });
})
