angular.module("app.modules.user-manager.superadmins.create", [])

.config(function($stateProvider) {
  $stateProvider
    .state('loggedIn.modules.user-manager.superadmins.create', {
      url: '/create',
      views: {
        'manager-content@loggedIn.modules.user-manager': {
          templateUrl: 'modules/user-manager/superadmins/create/create.tpl.html',
          controller: 'UserManagerSuperAdminsCreateController'
        }
      }
    });
})

.controller('UserManagerSuperAdminsCreateController', function($scope, $state, $translate, IMAGECONFIGS, ERRORCODES, utils, security, STATES, superadmins) {
