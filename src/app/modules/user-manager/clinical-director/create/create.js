angular.module("app.modules.user-manager.clinical-director.create", [])

.config(function($stateProvider) {
  $stateProvider
    .state('loggedIn.modules.user-manager.clinical-director.create', {
      url: '/create',
      views: {
        'manager-content@loggedIn.modules.user-manager': {
          templateUrl: 'modules/user-manager/clinical-director/create/create.tpl.html',
          controller: 'UserManagerClinicalDirectorCreateController'
        }
      }
    });
})

.controller('UserManagerClinicalDirectorCreateController', function($scope, $state, $translate, IMAGECONFIGS, STATES, ERRORCODES, utils, security, clinicalDirectors) {
